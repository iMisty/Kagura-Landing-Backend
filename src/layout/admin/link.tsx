...
export default class AdminLink extends Vue {
  private saveIcon: object = require('@/assets/save.svg');
   ...
   */
  private getLinkData() {
    const data = localStorage.getItem('user_link') || this.$store.state.link;
    console.log(data);
    this.linkData = data;
  }
            ...
            return (
              <table class="admin__link--table">
                <tr class="admin__link--table--wrap">
                  ...
                  <th class="admin__link--table--setting">
                ...
                <th class="admin__link--options" data-index={index}>
                  <m-button onClickevent={this.createNewItem}>增加项</m-button>
                  <m-button>保存项</m-button>
                  <m-button>删除整项</m-button>
                </th>
              </table>
            );
          })}
